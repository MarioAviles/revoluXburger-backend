    ...
    public void run(String... args) throws Exception {
        if (menuRepository.count() == 0) {
            menuRepository.saveAll(List.of(
                    ...
                    new Menu(null, "Morena Mía", "Rúcula, queso suave, carne de waygu y cebolla dulce. Elegancia con sabor atrevido.", Burger, Medallon, BigDecimal.valueOf(12), 1200L, "/images/burgers/https://res.cloudinary.com/ddxoloq91/image/upload/v1747475702/Morena_Mia_kbuh7w.png"),
